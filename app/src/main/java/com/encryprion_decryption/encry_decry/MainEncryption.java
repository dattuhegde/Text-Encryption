...
public class MainEncryption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_encryption);
            ...
            public void onClick(View view) {
                try {
                    ...
                    if(TextUtils.isEmpty(etkey) || TextUtils.isEmpty(etmsg)){
                        Toast.makeText(MainEncryption.this, "Enter everything", Toast.LENGTH_SHORT).show();
                    }else {
